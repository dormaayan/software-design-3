...
public class EndToEndTest {
    ...
    public void userMadeLotsOfActionsInAllPossibleCombinationsShouldHaveValidSubscriptions() throws Exception {
        ...
        assertThat(user7History.get("j1"), IsIterableContainingInOrder.contains(false, true, true, false, true, true, true));
...
//////////
    ...
    @Test
    public void userSubscribedToMultipleJournalsAndNeverCancelledShouldHaveBudgetOfAllSubscribedJournals() throws Exception {
        setUp("ourSmall.csv");
        SubscriberReader reader = injector.getInstance(SubscriberReader.class);
    ...
    @Test
    public void journalWithMultipleSubscriptionAndCancelationsShouldHaveIncomeOfItsPriceTimesActiveSubscriptions() throws Exception {
        setUp("ourSmall.json");
        SubscriberReader reader = injector.getInstance(SubscriberReader.class);
